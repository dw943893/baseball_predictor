...
d = st.number_input('Home team double plays against visiting team', min_value = 0)
e = st.number_input('Home team errors', min_value = 0)
f = st.number_input('Home team players left on base', min_value = 0)
g = st.number_input('Home team players caught stealing', min_value = 0)
...
k = st.number_input('Visiting team double plays against home team', min_value = 0)
j = st.number_input('Visiting team errors', min_value = 0)
h = st.number_input('Visiting team players left on base', min_value = 0)
i = st.number_input('Visiting team players caught stealing', min_value = 0)
